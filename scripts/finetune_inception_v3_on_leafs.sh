...
# 2. Fine-tunes an InceptionV3 model on the leafs training set.
# 3. Evaluates the model on the leafs validation set.
#
# Usage:
# cd slim
# ./slim/scripts/finetune_inception_v3_on_leafs.sh
set -e
...
TRAIN_DIR=/tmp/leafs-models/inception_v3
...
# Fine-tune only the new layers for 4000 steps.
